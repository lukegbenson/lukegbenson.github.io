...
description: "Explaining car usage in US cities using solely the footprints of their parking lots."
date: 2026-01-08
...
Other than geographic coordinates, there are no actual variables in this data: no indication of lot structure, no total car capacity or price of parking. Therefore, to try to predict car usage, we need to engineer variables using just the geographic locations of the lots.
...
<figure style="width: 80%; margin: auto;">
  <img src="lots_san_bernardino.png" style="width: 100%;">
  <figcaption>Parking lots in San Bernardino, California.</figcaption>
</figure>
...
<figure style="width: 80%; margin: auto;">
  <img src="lots_long_beach.png" style="width: 100%;">
  <figcaption>Parking area is unevenly distributed among lots in Long Beach, Caifornia.</figcaption>
</figure>
...
<figure style="width: 80%; margin: auto;">
  <img src="lots_houston.png" style="width: 100%;">
  <figcaption>Parking in Houston, Texas, is evenly distributed and ordered within the city grid.</figcaption>
</figure>
...
<figure style="width: 80%; margin: auto;">
  <img src="lots_rose_houston.png" style="width: 100%;">
  <figcaption>The rose diagram reveals the high degree of directional order among parking lots in Houston.</figcaption>
</figure>
...
<figure style="width: 80%; margin: auto;">
  <img src="lots_estimated_usage.png" style="width: 100%;">
  <figcaption>Actual car usage vs. estimated car usage. Using just parking lot footprints, we can explain 50.4% of the variation in car usage.</figcaption>
</figure>
...
<figure style="width: 80%; margin: auto;">
  <img src="lots_size_density_footprint.png" style="width: 100%;">
  <figcaption>Lot size, density, and total footprint. The total lot percentage is simply the product of average lot size and lot density. Cities may have the same parking footprint with high density and small lots or low density and large lots.</figcaption>
</figure>


# Moving forward

No, I am not recommending that we use only parking lot features to predict how car usage might change in the future. But, nevertheless, the connection between the physical space designated for car storage and the tendency for people to drive their cars is clear. If we continue to design our cities as giant storage units for cars, we can’t be surprised when our streets remain filled with them.
